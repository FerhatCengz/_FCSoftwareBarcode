let TYPE_TEXT = "TEXT",
  ...
  Logger = {
    ...
    logScanSuccess: function (e, t) {
      gtag("event", "ScanSuccess", { event_category: e, event_label: t }),
...
function showBanner(e, t) {
  hideBanners(),
    ...
    !1 === t &&
      ((selector = ".banner.error"), (textId = "banner-error-message")),
    (document.getElementById(textId).innerText = e),
...
function shareResult(e, t) {
  const n = { title: "Scan result from Scanapp.org", text: e };
  t == TYPE_URL && (n.url = e),
    navigator
      .share(n)
      .then(function () {
...
function createLinkTyeUi(e, t, n) {
  ...
  (o.href = t),
    n == TYPE_PHONE && (t = t.toLowerCase().replace("tel:", "")),
    (o.innerText = t),
    e.appendChild(o);
}
...
function createWifiTyeUi(e, t) {
  ...
  addKeyValuePairUi(e, "SSID", n[1]),
    addKeyValuePairUi(e, "Type", n[2]),
    addKeyValuePairUi(e, "Password", n[3]);
}
function createUpiTypeUi(e, t) {
  var n = new URL(t).searchParams,
    o = n.get("cu");
  o && null != o && addKeyValuePairUi(e, "Currency", o),
    addKeyValuePairUi(e, "Payee address", n.get("pa"));
  var i = n.get("pn");
...
let QrResult = function (e) {
  ...
  let g = { text: null, type: null };
  u.addEventListener("click", function () {
    hideBanners(),
      (t.style.display = "none"),
      e && (Logger.logScanRestart(), e()),
  ...
  navigator.clipboard
    ...
    s.addEventListener("click", function (e) {
      ...
      (location.href = t),
        showBanner(
          "Payment action only works if UPI payment apps are installed."
        ),
    ...
    (this.__onScanSuccess = function (e, o, c) {
      l.classList.add("hidden"),
        (n.innerText = (function (e) {
          return e;
        })(o.result.format.formatName)),
        (i.innerText = e);
      let d = detectType(e);
      Logger.logScanSuccess(c, d),
        (g.text = e),
        (g.type = d),
        (a.innerText = d),
        r.replaceChildren ? r.replaceChildren() : (r.innerHTML = ""),
        r.appendChild(
          (function (e, t) {
            let n = document.createElement("div");
            return (
              (s.style.display = t == TYPE_UPI ? "inline-block" : "none"),
              t == TYPE_URL || t == TYPE_PHONE
                ? (createLinkTyeUi(n, e, t), n)
                : t == TYPE_WIFI
                ? (createWifiTyeUi(n, e), n)
                : t == TYPE_UPI
                ? (createUpiTypeUi(n, e), n)
                : ((n.innerText = e), n)
            );
          })(e, d)
        ),
...
function showAntiEmbedWindow() {
  ...
  (t.disabled = !0),
    (function e() {
      n--,
        (t.innerText = `Continue here (${n})`),
        n > 0
          ? setTimeout(e, 1e3)
          : ((t.innerText = "Continue using here"), (t.disabled = !1));
    })(),
...
(QrResult.prototype.onScanSuccess = function (e, t, n) {
  ...
  docReady(function () {
    ...
    let t = new Html5QrcodeScanner("reader", {
        ...
        experimentalFeatures: { useBarCodeDetectorIfSupported: !0 },
    ...
    t.render(function (e, o) {
      console.log(e, o);
      //!Burada eklendiğinde o bardoun olup olamdığını anlamaya çalış.
      t.getState() !== Html5QrcodeScannerState.NOT_STARTED && t.pause(!0);
      let i = "camera";
      t.getState() === Html5QrcodeScannerState.NOT_STARTED && (i = "file"),
        n.onScanSuccess(e, o, i);
    }),
